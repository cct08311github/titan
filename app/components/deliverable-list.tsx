      ...
      {items.map((item) => {
        ...
        return (
          <div
            key={item.id}
            className={cn(
              "flex items-center gap-2 group px-2 py-2 rounded-md hover:bg-muted/50 transition-colors",
      ...
      {showForm ? (
        <div className="flex items-center gap-2 mt-2 p-2 bg-muted/50 rounded-md">
          ...
          <select
            ...
            className="bg-card border border-border text-foreground text-xs rounded px-1.5 py-1 focus:outline-none"
          >
