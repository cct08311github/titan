...
const DEFAULT_GATES = [
  {
    ...
    order: 1,
    checklist: [
      { item: "需求規格書已完成並版本化", checked: false, note: "" },
      { item: "需求方已書面簽核確認", checked: false, note: "" },
      { item: "需求範圍（Scope）已明確定義", checked: false, note: "" },
      { item: "驗收條件（Acceptance Criteria）已定義", checked: false, note: "" },
      { item: "非功能需求（效能/安全/可用性）已定義", checked: false, note: "" },
      { item: "需求追溯矩陣（RTM）已建立", checked: false, note: "" },
      { item: "利害關係人已識別並記錄", checked: false, note: "" },
    ],
  },
  {
    name: "G2 設計審查",
    ...
    order: 2,
    checklist: [
      { item: "系統架構設計文件已完成", checked: false, note: "" },
      { item: "資料庫 ER 圖/Schema 設計已確認", checked: false, note: "" },
      { item: "API 規格文件已定義", checked: false, note: "" },
      { item: "安全設計審查已通過（資安科）", checked: false, note: "" },
      { item: "效能需求的技術方案已確認", checked: false, note: "" },
      { item: "與現有系統的整合方案已確認", checked: false, note: "" },
      { item: "開發環境/工具/框架已備妥", checked: false, note: "" },
    ],
  },
  {
    name: "G3 開發完成",
    ...
    order: 3,
    checklist: [
      { item: "所有功能開發完成", checked: false, note: "" },
      { item: "單元測試覆蓋率達標（≥80%）", checked: false, note: "" },
      { item: "Code Review 全數完成", checked: false, note: "" },
      { item: "技術債務已清理或記錄", checked: false, note: "" },
      { item: "開發文件/API 文件已更新", checked: false, note: "" },
      { item: "安全弱點靜態掃描通過", checked: false, note: "" },
      { item: "整合測試環境已部署", checked: false, note: "" },
    ],
  },
  {
    name: "G4 UAT 通過",
    ...
    order: 4,
    checklist: [
      { item: "SIT 測試計畫執行完成", checked: false, note: "" },
      { item: "SIT 缺陷全部修復或有豁免紀錄", checked: false, note: "" },
      { item: "UAT 測試計畫執行完成", checked: false, note: "" },
      { item: "UAT 使用者書面簽核通過", checked: false, note: "" },
      { item: "效能/壓力測試通過", checked: false, note: "" },
      { item: "安全弱點動態掃描通過（DAST）", checked: false, note: "" },
      { item: "回歸測試通過", checked: false, note: "" },
      { item: "測試報告已產出", checked: false, note: "" },
    ],
  },
  {
    name: "G5 上線核准",
    ...
    order: 5,
    checklist: [
      { item: "上線部署計畫已確認（含時間窗口）", checked: false, note: "" },
      { item: "回滾方案已確認並演練", checked: false, note: "" },
      { item: "資料遷移計畫已確認（如適用）", checked: false, note: "" },
      { item: "維運團隊交接完成（SOP/監控/告警）", checked: false, note: "" },
      { item: "教育訓練已完成", checked: false, note: "" },
      { item: "操作手冊/使用者手冊已交付", checked: false, note: "" },
      { item: "監控告警設定完成", checked: false, note: "" },
      { item: "災備/DR 方案已更新", checked: false, note: "" },
      { item: "部門主管核准上線", checked: false, note: "" },
    ],
  },
];
